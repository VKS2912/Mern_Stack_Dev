...
//action
import { getCoinPlan, deleteCoinPlan } from "../../store/coinPlan/action";
...
const CoinPlanTable = (props) => {
  ...
  useEffect(() => {
    props.getCoinPlan(); // eslint-disable-next-line
  }, []);
...
export default connect(null, { getCoinPlan, deleteCoinPlan })(CoinPlanTable);
