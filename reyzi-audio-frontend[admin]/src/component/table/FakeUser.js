...
const FakeUser = (props) => {
  ...
  useEffect(() => {
    props.getFakeUser(activePage, rowsPerPage, search, sDate, eDate, "Fake"); // eslint-disable-next-line
  ...
  const getAllUser = () => {
    ...
    seteDate("ALL");
    $("#datePicker").removeClass("show");
    props.getFakeUser(activePage, rowsPerPage, search, sDate, eDate);
  };
        ...
        <div className=" mb-2">
          {/* <div>
            <Link
              ...
              style={{
                marginRight: 5,
                backgroundColor: "rgb(252, 148, 148)",
              }}
            >
              App
            </Link>
