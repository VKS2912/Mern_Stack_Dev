...
const FakeVideo = (props) => {
  ...
  useEffect(() => {
    props.getFakeVideo(null, activePage, rowsPerPage, sDate, eDate); // eslint-disable-next-line
  ...
  const getAllVideo = () => {
    ...
    seteDate("ALL");
    $("#datePicker").removeClass("show");
    props.getFakeVideo(null, activePage, rowsPerPage, sDate, eDate, "Fake");
  };
                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <video
                              height="50px"
                              width="50px"
                              src={data.fakeVideoType == 0 ? data.video : baseURL+ data.video}
